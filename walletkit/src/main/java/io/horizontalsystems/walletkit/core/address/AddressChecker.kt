...
class PhishingAddressChecker(
    ...
    private val supportedBlockchainTypes =  EvmBlockchainManager.blockchainTypes + listOf(BlockchainType.Tron, BlockchainType.Stellar, BlockchainType.Xrp, BlockchainType.Near, BlockchainType.Solana)
