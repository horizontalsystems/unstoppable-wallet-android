package io.horizontalsystems.walletkit.modules.watchaddress
...
import io.horizontalsystems.walletkit.entities.tokenType
...
class WatchAddressViewModel(
    ...
    fun onEnterViewKey(key: String) {
        ...
        try {
            ChainRegistry[BlockchainType.Monero]?.validateWatchViewKey(key, address.hex)
    ...
    private fun getAccountType() = when (type) {
        ...
        Type.MayachainAddress -> address?.let {
            AccountType.MayachainAddress(it.hex)
        }
