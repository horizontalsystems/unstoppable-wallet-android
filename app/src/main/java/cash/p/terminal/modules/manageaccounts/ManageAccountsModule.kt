...
object ManageAccountsModule {
    ...
    const val customNameKey = "customNameKey"
    ...
    fun prepareParams(popOffOnSuccess: Int, customName: String?) = bundleOf(popOffOnSuccessKey to popOffOnSuccess, customNameKey to customName)
