...
class CexProviderManager(
    ...
    private fun handleAccount(account: Account?) {
        val cexProvider =
            when (val cexType = (account?.type as? AccountType.Cex)?.cexType) {
        ...
        return coinInfo
            ...
            .map {
                ...
                CexAssetRaw(
                    ...
                    depositNetworks =
                        it.networkList.map { coinNetwork ->
