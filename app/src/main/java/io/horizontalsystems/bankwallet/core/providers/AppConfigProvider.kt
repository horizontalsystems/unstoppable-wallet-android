...
class AppConfigProvider : IAppConfigProvider, ILanguageConfigProvider, IBuildConfigProvider {
    ...
    override val otherCoins: List<Coin> by lazy {
        listOf(
                ...
                Coin("MCX",         "MachiX Token",         "MCX",      18, CoinType.Erc20("0xd15ecdcf5ea68e3995b2d0527a0ae0a3258302f8")),
                ...
                Coin("MBC",         "Marblecoin",           "MBC",      18, CoinType.Erc20("0x8888889213dd4da823ebdd1e235b09590633c150")),
                ...
                Coin("SFWL",        "Swapfolio",            "SFWL",     18, CoinType.Erc20("0xBa21Ef4c9f433Ede00badEFcC2754B8E74bd538A")),
