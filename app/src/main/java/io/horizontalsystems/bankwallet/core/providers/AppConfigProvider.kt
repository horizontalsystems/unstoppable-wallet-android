...
class AppConfigProvider : IAppConfigProvider, ILanguageConfigProvider, IBuildConfigProvider {
    ...
    override val uniswapGraphUrl = App.instance.getString(R.string.uniswapGraphUrl)
    ...
    override val otherCoins: List<Coin> by lazy {
        listOf(
                ...
                Coin("0xBTC",       "0xBitcoin Token",      "0xBTC",    18, CoinType.Erc20("0xB6eD7644C69416d67B522e20bC294A9a9B405B31")),
                ...
                Coin("TRYB",        "BiLira",               "TRYB",     6, CoinType.Erc20("0x2c537e5624e4af88a7ae4060c022609376c8d0eb")),
                ...
                Coin("CELR",        "CelerToken",           "CELR",     18, CoinType.Erc20("0x4f9254c83eb525f9fcf346490bbb3ed28a81c667")),
                ...
                Coin("DATA",        "DATAcoin",             "DATA",     18, CoinType.Erc20("0x0cf0ee63788a0849fe5297f3407f701e122cc023")),
                Coin("RING",        "Darwinia Network Native Token",           "RING",    18, CoinType.Erc20("0x9469d013805bffb7d3debe5e7839237e535ec483")),
                Coin("MANA",        "Decentraland",         "MANA",     18, CoinType.Erc20("0x0F5D2fB29fb7d3CFeE444a200298f468908cC942")),
                Coin("DEFI",        "DeFi Token",           "DEFI",     8, CoinType.Binance("DEFI-FA5")),
                ...
                Coin("DONUT",       "Donut",                "DONUT",    18, CoinType.Erc20("0xc0f9bd5fa5698b6505f643900ffa515ea5df54a9")),
                ...
                Coin("EBASE",       "EURBASE Stablecoin",   "EBASE",    18, CoinType.Erc20("0x86FADb80d8D2cff3C3680819E4da99C10232Ba0F")),
                ...
                Coin("FXC",         "Flexacoin",            "FXC",      18, CoinType.Erc20("0x4a57e687b9126435a9b19e4a802113e266adebde")),
                Coin("FOAM",        "FOAM Token",           "FOAM",     18, CoinType.Erc20("0x4946fcea7c692606e8908002e55a582af44ac121")),
                Coin("iDAI",        "Fulcrum DAI iToken",   "iDAI",     18, CoinType.Erc20("0x493C57C4763932315A328269E1ADaD09653B9081")),
                Coin("iSAI",        "Fulcrum SAI iToken",   "iSAI",     18, CoinType.Erc20("0x14094949152EDDBFcd073717200DA82fEd8dC960")),
                ...
                Coin("DATA",        "Gnosis",               "DATA",     18, CoinType.Erc20("0x6810e776880c02933d47db1b9fc05908e5386b96")),
                ...
                Coin("ONE",         "Harmony.One",          "ONE",      8, CoinType.Binance("ONE-5F9")),
                ...
                Coin("HYN",         "Hyperion Token",       "HYN",      8, CoinType.Binance("HYN-F21")),
                ...
                Coin("IRIS",        "IRIS Network",         "IRIS",     8, CoinType.Binance("IRIS-D88")),
                ...
                Coin("MGN",         "Magnolia Token",       "MGN",      18, CoinType.Erc20("0x80f222a749a2e18Eb7f676D371F19ad7EFEEe3b7")),
                ...
                Coin("MOD",         "Modum Token",          "MOD",      0, CoinType.Erc20("0x957c30aB0426e0C93CD8241E2c60392d08c6aC8e")),
                ...
                Coin("USD++",       "PieDAO USD++ Pool",    "USD++",    18, CoinType.Erc20("0x9A48BD0EC040ea4f1D3147C025cd4076A2e71e3e")),
                Coin("BTC++",       "PieDAO BTC++",         "BTC++",    18, CoinType.Erc20("0x0327112423F3A68efdF1fcF402F6c5CB9f7C33fd")),
                ...
                Coin("QCH",         "QChi",                 "QCH",      18, CoinType.Erc20("0x687BfC3E73f6af55F0CccA8450114D107E781a0e")),
                ...
                Coin("RUNE",        "Rune",                 "RUNE",     8, CoinType.Binance("RUNE-B1A")),
                ...
                Coin("XOR",         "Sora Token",           "XOR",      18, CoinType.Erc20("0x40FD72257597aA14C7231A7B1aaa29Fce868F677")),
                Coin("SNT",         "Status",               "SNT",      18, CoinType.Erc20("0x744d70FDBE2Ba4CF95131626614a1763DF805B9E")),
                Coin("STAKE",       "STAKE",                "STAKE",    18, CoinType.Erc20("0x0Ae055097C6d159879521C384F1D2123D1f195e6")),
                Coin("SWINGBY",     "Swingby Token",        "SWINGBY",  8, CoinType.Binance("SWINGBY-888")),
                ...
                Coin("UTK",         "Utrust Token",         "UTK",      18, CoinType.Erc20("0xdc9Ac3C20D1ed0B540dF9b1feDC10039Df13F99c")),
                ...
                Coin("WCK",         "Wrapped CryptoKitties","WCK",      18, CoinType.Erc20("0x09fe5f0236f0ea5d930197dce254d77b04128075")),
