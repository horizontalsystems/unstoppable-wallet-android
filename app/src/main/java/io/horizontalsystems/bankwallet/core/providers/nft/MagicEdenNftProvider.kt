...
class MagicEdenNftProvider(
        private val marketKit: MarketKitWrapper,
        appConfigProvider: AppConfigProvider
) : INftProvider {

    private val service: MagicEdenService = MagicEdenService(appConfigProvider.marketApiBaseUrl, appConfigProvider.marketApiKey)
    ...
    override suspend fun assetsBriefMetadata(blockchainType: BlockchainType, nftUids: List<NftUid>): List<NftAssetBriefMetadata> {
        ...
        for (nftUidsChunk in chunkedNftUids) {
            ...
            assetsBriefList.addAll(assetsBrief(response.assets))
        }
    ...
    private fun collectionMetadata(
            blockchainType: BlockchainType,
            response: MagicEdenNftApiResponse.Collection,
    ...
    private fun assetMetadata(
            blockchainType: BlockchainType,
            response: MagicEdenNftApiResponse.Asset,
    ...
    private fun saleInfo(
            ...
            orders: List<MagicEdenNftApiResponse.Asset.Order>,
    ...
    private fun assets(blockchainType: BlockchainType, responses: List<MagicEdenNftApiResponse.Asset>): List<NftAssetMetadata> {
        val addresses = mutableListOf<String>()
    ...
    private fun collections(blockchainType: BlockchainType, responses: List<MagicEdenNftApiResponse.Collection>): List<NftCollectionMetadata> {
    ...
    private fun events(blockchainType: BlockchainType, responses: List<MagicEdenNftApiResponse.Event>): List<NftEventMetadata> {
        val addresses = mutableListOf<String>()
        responses.forEach { response ->
    ...
    private fun assetsBrief(assets: List<MagicEdenNftApiResponse.Asset>): List<NftAssetBriefMetadata> = assets.map {
        NftAssetBriefMetadata(
                nftUid = NftUid.Solana(it.token_id),
    ...
    private fun openSeaEventType(eventType: NftEventMetadata.EventType?): String? =
            when (eventType) {
                NftEventMetadata.EventType.List -> "created"
                NftEventMetadata.EventType.Sale -> "successful"
                NftEventMetadata.EventType.OfferEntered -> "offer_entered"
                NftEventMetadata.EventType.BidEntered -> "bid_entered"
                NftEventMetadata.EventType.BidWithdrawn -> "bid_withdrawn"
                NftEventMetadata.EventType.Transfer -> "transfer"
                NftEventMetadata.EventType.Approve -> "approve"
                NftEventMetadata.EventType.Custom -> "custom"
                NftEventMetadata.EventType.Payout -> "payout"
                NftEventMetadata.EventType.Cancel -> "cancelled"
                NftEventMetadata.EventType.BulkCancel -> "bulk_cancel"
                NftEventMetadata.EventType.All,
                NftEventMetadata.EventType.Unknown,
                null -> null
            }

    private fun eventType(openSeaEventType: String?): NftEventMetadata.EventType? =
            when (openSeaEventType) {
                "created" -> NftEventMetadata.EventType.List
                "successful" -> NftEventMetadata.EventType.Sale
                "offer_entered" -> NftEventMetadata.EventType.OfferEntered
                "bid_entered" -> NftEventMetadata.EventType.BidEntered
                "bid_withdrawn" -> NftEventMetadata.EventType.BidWithdrawn
                "transfer" -> NftEventMetadata.EventType.Transfer
                "approve" -> NftEventMetadata.EventType.Approve
                "custom" -> NftEventMetadata.EventType.Custom
                "payout" -> NftEventMetadata.EventType.Payout
                "cancelled" -> NftEventMetadata.EventType.Cancel
                "bulk_cancel" -> NftEventMetadata.EventType.BulkCancel
                else -> null
            }
