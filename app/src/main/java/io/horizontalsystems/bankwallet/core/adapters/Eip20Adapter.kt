...
class Eip20Adapter(
    ...
    private val transactionConverter = EvmTransactionConverter(coinManager, evmKitWrapper, wallet.transactionSource, App.evmSpamManager, baseToken, evmLabelManager)
