...
class NumberRounding {
    ...
    fun getRoundedShort(value: BigDecimal): BigDecimalRounded = getRoundedShort(value, 8)

    fun getRoundedCoinShort(
        value: BigDecimal,
        coinDecimals: Int,
    ): BigDecimalRounded = getRoundedShort(value, coinDecimals)

    fun getRoundedCoinFull(
        value: BigDecimal,
        coinDecimals: Int,
    ): BigDecimalRounded = getRoundedFull(value, 4.coerceAtMost(coinDecimals), coinDecimals)

    fun getRoundedCurrencyShort(
        value: BigDecimal,
        currencyDecimals: Int,
    ): BigDecimalRounded = getRoundedShort(value, currencyDecimals)

    fun getRoundedCurrencyFull(value: BigDecimal): BigDecimalRounded = getRoundedFull(value, 0, 18)
    ...
    private fun getNumberOfZerosAfterDot(value: BigDecimal): Int = value.scale() - value.precision()
