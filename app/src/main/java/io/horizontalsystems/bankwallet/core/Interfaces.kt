...
interface IReceiveAdapter {
    ...
    suspend fun isAddressActive(address: String): Boolean = true

    fun usedAddresses(change: Boolean): List<UsedAddress> = listOf()
}
