...
abstract class BitcoinBaseAdapter(open val kit: AbstractKit, private val addressParser: AddressParser) : IAdapter, ITransactionsAdapter, IBalanceAdapter, IReceiveAdapter, ISendAdapter {
