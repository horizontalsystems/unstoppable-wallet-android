...
class RestoreSettingsStorage(
    ...
    ): List<RestoreSettingRecord> = dao.get(accountId, blockchainTypeUid)

    override fun restoreSettings(accountId: String): List<RestoreSettingRecord> = dao.get(accountId)
