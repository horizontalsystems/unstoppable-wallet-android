...
class AppConfigProvider : IAppConfigProvider {
    ...
    override val coins: List<Coin> = listOf(
            ...
            Coin("Binance Chain",           "BNB",          CoinType.Binance("BNB")),
            ...
            Coin("Ankr Network",            "ANKR",         CoinType.Binance("ANKR-E97")),
            ...
            Coin("Binance Coin",            "BNB-ERC20",    CoinType.Erc20("0xB8c77482e45F1F44dE1745F52C74426C631bDD52", 18)),
            Coin("Bitcoin BEP2",            "BTCB",         CoinType.Binance("BTCB-1DE")),
            Coin("Cashaaa",                 "CAS",          CoinType.Binance("CAS-167")),
            ...
            Coin("Crypto.com Chain",        "CRO",          CoinType.Erc20("0xA0b73E1Ff0B80914AB6fe0444E65848C4C34450b", 8)),
            Coin("Crypterium",              "CRPT",         CoinType.Binance("CRPT-8C9")),
            ...
            Coin("EOSDT",                   "EOSDT",        CoinType.Eos("eosdtsttoken", "EOSDT")),
            ...
            Coin("Loopring",                "LRC",          CoinType.Erc20("0xEF68e7C694F40c8202821eDF525dE3782458639f", 18)),
            Coin("Maker",                   "MKR",          CoinType.Erc20("0x9f8F72aA9304c8B593d555F12eF6589cC3A579A2", 18)),
            Coin("MEET.ONE",                "MEETONE",      CoinType.Eos("eosiomeetone", "MEETONE")),
            ...
            Coin("Newdex",                  "NDX",          CoinType.Eos("newdexissuer", "NDX")),
            Coin("Native Utility Token",    "NUT",          CoinType.Eos("eosdtnutoken", "NUT")),
            Coin("OmiseGO",                 "OMG",          CoinType.Erc20("0xd26114cd6EE289AccF82350c8d8487fedB8A0C07", 18)),
            Coin("Orbs",                    "ORBS",         CoinType.Erc20("0xff56Cc6b1E6dEd347aA0B7676C85AB0B3D08B0FA", 18)),
            Coin("Prospectors Gold",        "PGL",          CoinType.Eos("prospectorsg", "PGL")),
            ...
            Coin("Paytomat",                "PTI",          CoinType.Eos("ptitokenhome", "PTI")),
