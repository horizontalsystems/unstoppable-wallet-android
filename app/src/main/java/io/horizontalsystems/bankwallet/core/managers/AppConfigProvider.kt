...
class AppConfigProvider : IAppConfigProvider {
    ...
    override val coins: List<Coin> = listOf(
            ...
            Coin("EOSDT",                   "EOSDT",        4,      CoinType.Eos("eosdtsttoken", "EOSDT")),
            Coin("Everipedia",              "IQ",           4,      CoinType.Eos("everipediaiq", "IQ")),
            ...
            Coin("Native Utility Token",    "NUT",          4,      CoinType.Eos("eosdtnutoken", "NUT")),
