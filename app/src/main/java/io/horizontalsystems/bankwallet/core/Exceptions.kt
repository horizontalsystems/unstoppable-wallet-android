...
class AdapterErrorWrongParameters(
    override val message: String,
) : Exception()
...
class NoDataException : Exception() {
    override fun getLocalizedMessage(): String = Translator.getString(R.string.CoinPage_NoData)
}

class NoAuthTokenException(
    override val message: String = "Auth Token is not set or empty",
) : Exception()

class InvalidAuthTokenException(
    override val message: String = "Auth Token is expired or invalid",
) : Exception()
