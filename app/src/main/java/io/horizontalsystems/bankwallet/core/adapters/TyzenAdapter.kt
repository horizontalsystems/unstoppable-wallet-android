...
import io.horizontalsystems.tyzenkit.TyzenKit
import io.horizontalsystems.tyzenkit.TyzenKit.NetworkType
import java.math.BigDecimal

class TyzenAdapter(
        override val kit: TyzenKit,
        syncMode: BitcoinCore.SyncMode,
        backgroundManager: BackgroundManager,
        wallet: Wallet,
        testMode: Boolean
) : BitcoinBaseAdapter(kit, syncMode, backgroundManager, wallet, testMode), TyzenKit.Listener, ISendBitcoinAdapter {
    ...
    override fun getTransactionUrl(transactionHash: String): String? =
        if (testMode) null else "https://explorer.tyzen.io/tx/$transactionHash"
    ...
    override val blockchain = BtcBlockchain.Tyzen
    ...
    companion object {
        ...
        private fun createKit(wallet: Wallet, syncMode: BitcoinCore.SyncMode, testMode: Boolean): TyzenKit {
            ...
            return TyzenKit(context = App.instance,
        ...
        fun clear(walletId: String, testMode: Boolean) {
            TyzenKit.clear(App.instance, getNetworkType(testMode), walletId)
        }
    }
}
