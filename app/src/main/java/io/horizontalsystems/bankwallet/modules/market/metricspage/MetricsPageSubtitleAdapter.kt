...
import kotlinx.android.synthetic.main.view_holder_market_metrics_subtitle.*
import java.math.BigDecimal

class MetricsPageSubtitleAdapter(
    viewItemLiveData: MutableLiveData<ViewItemWrapper>,
    viewLifecycleOwner: LifecycleOwner
) : ListAdapter<MetricsPageSubtitleAdapter.ViewItemWrapper, MetricsPageSubtitleAdapter.ViewHolder>(
    diff
) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(inflate(parent, R.layout.view_holder_market_metrics_subtitle, false))
    }
