...
object EvmFeeModule {
    ...
    fun surcharged(gasLimit: Long): Long = (gasLimit + gasLimit / 100.0 * surchargePercent).toLong()
...
sealed class Bound {
    ...
    fun calculate(selectedValue: Long) =
        when (this) {
...
data class FeeViewItem(
    ...
    fun wei(scaledValue: BigDecimal): Long = (scaledValue * BigDecimal(scale.scaleValue)).toLong()
}
