...
object BackupLocalModule {
    ...
    fun getAccountTypeString(accountType: AccountType): String =
        when (accountType) {
    ...
    fun getAccountTypeFromData(
        ...
        when (accountType) {
            ...
            BITCOIN_ADDRESS ->
                AccountType.BitcoinAddress.fromSerialized(
                    String(
                        data,
                        Charsets.UTF_8,
                    ),
    ...
    fun getDataForEncryption(accountType: AccountType): ByteArray =
        when (accountType) {
