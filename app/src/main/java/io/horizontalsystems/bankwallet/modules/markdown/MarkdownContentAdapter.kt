...
class MarkdownContentAdapter(
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int,
    ): MarkdownBlockViewHolder =
        when (viewType) {
            R.layout.view_holder_markdown_h1 ->
                ViewHolderH1(
            ...
            R.layout.view_holder_markdown_h2 ->
                ViewHolderH2(
            ...
            R.layout.view_holder_markdown_h3 ->
                ViewHolderH3(
            ...
            R.layout.view_holder_markdown_paragraph ->
                ViewHolderParagraph(
            ...
            R.layout.view_holder_markdown_image ->
                ViewHolderImage(
            ...
            R.layout.view_holder_markdown_footer ->
                ViewHolderFooter(
    ...
    override fun onBindViewHolder(
        holder: MarkdownBlockViewHolder,
        position: Int,
    ) {
    ...
    companion object {
        private val diffCallback =
            object : DiffUtil.ItemCallback<MarkdownBlock>() {
