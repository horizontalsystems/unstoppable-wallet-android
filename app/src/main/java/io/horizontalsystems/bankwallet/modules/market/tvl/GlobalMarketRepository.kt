...
class GlobalMarketRepository(
    ...
    fun getGlobalMarketPoints(
        ...
        marketKit
            .globalMarketPointsSingle(currencyCode, chartInterval)
            .map { list ->
                list.map { point ->
                    val value =
                        when (metricsType) {
    ...
    fun getTvlGlobalMarketPoints(
        ...
        marketKit
            .marketInfoGlobalTvlSingle(chain, currencyCode, chartInterval)
            .map { list ->
                list.map { point ->
    ...
    private fun getMarketTvlItems(
        ...
        val tvlItems =
            defiMarketInfoList.map { defiMarketInfo ->
