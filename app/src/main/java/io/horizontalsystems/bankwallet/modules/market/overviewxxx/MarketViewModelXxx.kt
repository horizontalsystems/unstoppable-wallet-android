...
import io.horizontalsystems.bankwallet.modules.market.overviewxxx.MarketModuleXxx.MarketOverviewViewItem
...
class MarketViewModelXxx(
    private val marketStorage: IMarketStorage,
    private val marketKit: MarketKitWrapper,
    private val currencyManager: CurrencyManager,
    localStorage: ILocalStorage
) : ViewModelUiState<MarketModuleXxx.UiState>() {
    ...
    override fun createState(): MarketModuleXxx.UiState {
        return MarketModuleXxx.UiState(
            selectedTab,
            marketOverviewItems
        )
    }
