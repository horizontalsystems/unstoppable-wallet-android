...
class AddTonTokenBlockchainService(
    private val blockchain: Blockchain,
) : AddTokenModule.IAddTokenBlockchainService {
    override fun isValid(reference: String) =
        try {
    ...
    override fun tokenQuery(reference: String): TokenQuery = TokenQuery(BlockchainType.Ton, TokenType.Jetton(reference))
