...
class ViewHolderCoinLoading(override val containerView: View) : RecyclerView.ViewHolder(containerView), LayoutContainer {
    companion object {
        fun create(parent: ViewGroup): ViewHolderCoinLoading {
            return ViewHolderCoinLoading(LayoutInflater.from(parent.context).inflate(R.layout.view_holder_coin_loading, parent, false))
        }
    }
}
