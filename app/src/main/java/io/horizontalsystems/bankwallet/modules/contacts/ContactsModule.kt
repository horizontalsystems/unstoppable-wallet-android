...
object ContactsModule {
    class ContactsViewModelFactory(
        ...
        override fun <T : ViewModel> create(modelClass: Class<T>): T = ContactsViewModel(App.contactsRepository, mode) as T
    }
    ...
    class ContactViewModelFactory(
        ...
        @Suppress("UNCHECKED_CAST")
        override fun <T : ViewModel> create(modelClass: Class<T>): T = ContactViewModel(App.contactsRepository, contact, newAddress) as T
    }
    ...
    sealed class ContactValidationException(
        override val message: String?,
    ) : Throwable() {
        object DuplicateContactName :
            ContactValidationException(Translator.getString(R.string.Contacts_Error_DefinedName))
