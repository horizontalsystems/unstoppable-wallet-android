...
class VipSupportViewModel(
    ...
    fun onRequestClicked() {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                val purchaseToken =
                    UserSubscriptionManager.activeSubscriptionStateFlow.value?.purchaseToken
...
object VipSupportModule {
    class Factory : ViewModelProvider.Factory {
        ...
        override fun <T : ViewModel> create(modelClass: Class<T>): T = VipSupportViewModel(App.marketKit) as T
    }
