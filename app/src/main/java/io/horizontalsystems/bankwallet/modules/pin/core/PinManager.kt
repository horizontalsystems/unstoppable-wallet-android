...
class PinManager(
    ...
    fun getPinLevel(pin: String): Int? = pinDbStorage.getLevel(pin)

    fun getPinLevelLast(): Int = pinDbStorage.getPinLevelLast()
    ...
    fun isPinSetForLevel(level: Int): Boolean = pinDbStorage.isPinSetForLevel(level)
