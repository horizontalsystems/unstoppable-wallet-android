...
class AddEvmTokenBlockchainService(
    ...
    override fun tokenQuery(reference: String): TokenQuery = TokenQuery(blockchain.type, TokenType.Eip20(reference.lowercase()))
    ...
    companion object {
        fun getInstance(blockchain: Blockchain): AddEvmTokenBlockchainService {
            ...
            val httpRpcSource =
                httpSyncSource?.rpcSource as? RpcSource.Http
