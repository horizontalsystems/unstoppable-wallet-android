...
class VaultChartFormatter : ChartModule.ChartNumberFormatter {
    ...
    override fun formatValue(currency: Currency, value: BigDecimal, numberFormatter: IAppNumberFormatter): String {
        return numberFormatter.format(value, 0, 2, "APY ", "%")
    }

    override fun formatMinMaxValue(currency: Currency, value: BigDecimal, numberFormatter: IAppNumberFormatter): String {
        return numberFormatter.format(value, 0, 2, "", "%")
    }
}
