...
object SelectBlockchainsModule {
    ...
    class Factory(val accountType: AccountType, val accountName: String?) : ViewModelProvider.Factory {
        ...
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            val service = WatchAddressService(App.accountManager, App.walletActivator, App.accountFactory)
            return SelectBlockchainsViewModel(accountType, accountName, service, App.evmBlockchainManager, App.marketKit) as T
        }
    }
}
