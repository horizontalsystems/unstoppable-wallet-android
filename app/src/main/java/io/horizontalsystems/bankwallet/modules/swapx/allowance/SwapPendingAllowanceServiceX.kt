package io.horizontalsystems.bankwallet.modules.swapx.allowance

import io.horizontalsystems.bankwallet.core.IAdapterManager
import io.horizontalsystems.bankwallet.core.adapters.Eip20Adapter
import io.horizontalsystems.bankwallet.entities.transactionrecords.evm.ApproveTransactionRecord
import io.horizontalsystems.bankwallet.modules.swapx.allowance.SwapPendingAllowanceState.Approved
import io.horizontalsystems.bankwallet.modules.swapx.allowance.SwapPendingAllowanceState.Approving
import io.horizontalsystems.bankwallet.modules.swapx.allowance.SwapPendingAllowanceState.NA
import io.horizontalsystems.bankwallet.modules.swapx.allowance.SwapPendingAllowanceState.Revoked
import io.horizontalsystems.bankwallet.modules.swapx.allowance.SwapPendingAllowanceState.Revoking
...
class SwapPendingAllowanceServiceX(
    ...
    private fun sync() {
        ...
        if (pendingAllowance == null || allowanceState == null || allowanceState !is SwapAllowanceServiceX.State.Ready) {
            state = NA
            return
        }
