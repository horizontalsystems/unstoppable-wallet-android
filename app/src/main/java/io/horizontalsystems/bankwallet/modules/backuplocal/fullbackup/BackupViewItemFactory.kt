...
class BackupViewItemFactory {
    ...
    ): Pair<List<SelectBackupItemsViewModel.WalletBackupViewItem>, List<SelectBackupItemsViewModel.OtherBackupViewItem>> {
        val walletBackupViewItems =
            backupItems.accounts.map { account ->
