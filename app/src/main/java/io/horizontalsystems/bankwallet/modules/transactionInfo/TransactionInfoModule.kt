...
object TransactionInfoModule {
    ...
    fun init(view: TransactionInfoViewModel, router: IRouter, transactionHash: String) {
        ...
        val presenter = TransactionInfoPresenter(transactionHash, interactor, router, TransactionViewItemFactory(App.walletManager, App.currencyManager, App.rateManager))
