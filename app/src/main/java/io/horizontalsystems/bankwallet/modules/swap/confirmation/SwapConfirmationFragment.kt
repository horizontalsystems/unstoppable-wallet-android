...
import io.horizontalsystems.bankwallet.modules.swap.confirmation.SwapConfirmationModule.TransactionDataParcelable
...
class SwapConfirmationFragment : BaseFragment() {
    ...
    private val transactionData: TransactionData
        get() {
            val transactionDataParcelable = arguments?.getParcelable<TransactionDataParcelable>(SwapConfirmationModule.transactionDataKey)!!
