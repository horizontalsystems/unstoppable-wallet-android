...
class WordsInputAdapter(private val listener: InputTextViewHolder.WordsChangedListener, val autocompleteAdapter: ArrayAdapter<String>) : RecyclerView.Adapter<InputTextViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): InputTextViewHolder {
        ...
        return InputTextViewHolder(inputTextView, listener, autocompleteAdapter)
    }
