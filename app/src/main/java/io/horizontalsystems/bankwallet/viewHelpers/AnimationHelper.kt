...
object AnimationHelper {
    ...
    fun expand(v: View) {
        ...
        // 1dp/ms
        a.duration = (((targetHeight / v.context.resources.displayMetrics.density)) * 3).toLong()
        v.startAnimation(a)
    }
    ...
    fun collapse(v: View) {
        ...
        // 1dp/ms
        a.duration = (((initialHeight / v.context.resources.displayMetrics.density)) * 3).toLong()
        v.startAnimation(a)
    }
}
