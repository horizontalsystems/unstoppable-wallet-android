...
class NewPinActivity : BaseActivity(), NumPadItemsAdapter.Listener, FingerprintAuthenticationDialogFragment.Callback {
    ...
    private fun showFingerprintDialog() {
        if (App.systemInfoManager.touchSensorCanBeUsed()) {
            try {
                ...
                fragment.setCallback(this@NewPinActivity)
    ...
    companion object {
        ...
        fun start(context: Context, interactionType: NewPinInteractionType) {
