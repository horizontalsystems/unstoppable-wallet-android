...
class SendThorchainViewModel(
    val wallet: Wallet,
    private val sendToken: Token,
    val feeToken: Token,
    private val adapter: ISendThorchainAdapter,
    ...
    private val logger: AppLogger = AppLogger("send-thorchain")
    ...
    override fun createState() = SendThorchainUiState(
    ...
    private fun handleUpdatedAddressState(addressState: SendThorchainAddressService.State) {
...
data class SendThorchainUiState(
