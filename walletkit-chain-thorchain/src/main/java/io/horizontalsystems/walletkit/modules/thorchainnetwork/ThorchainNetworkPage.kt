...
@Serializable
data object ThorchainNetworkPage : HSPage() {

    @Composable
    override fun GetContent(navigation: HSNavigation) {
        ThorchainNetworkScreen(
            viewModel(factory = ThorchainNetworkModule.Factory()),
            navigation
        )
    }
...
@Composable
private fun ThorchainNetworkScreen(
    viewModel: ThorchainNetworkViewModel,
