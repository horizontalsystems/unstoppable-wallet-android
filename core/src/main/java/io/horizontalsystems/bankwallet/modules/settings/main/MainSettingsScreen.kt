...
private fun SettingSections(
    ...
    val isFDroidBuild = io.horizontalsystems.bankwallet.core.App.appConfigProvider.fdroidBuild
    ...
    CellUniversalLawrenceSection(
        buildList {
            ...
            if (!io.horizontalsystems.bankwallet.core.App.appConfigProvider.fdroidBuild) {
                add {
                    HsSettingCell(
