...
import io.horizontalsystems.core.core.blockTime
import io.horizontalsystems.core.core.hexToByteArray
import io.horizontalsystems.core.core.isEvm
import io.horizontalsystems.core.core.managers.APIClient
import io.horizontalsystems.core.modules.multiswap.SwapFinalQuote
import io.horizontalsystems.core.modules.multiswap.SwapQuote
import io.horizontalsystems.core.modules.multiswap.action.ISwapProviderAction
import io.horizontalsystems.core.modules.multiswap.providers.AllBridgeAPI.Response
import io.horizontalsystems.core.modules.multiswap.sendtransaction.SendTransactionData
import io.horizontalsystems.core.modules.multiswap.sendtransaction.SendTransactionSettings
import io.horizontalsystems.core.modules.multiswap.ui.DataFieldRecipient
import io.horizontalsystems.core.modules.multiswap.ui.DataFieldSlippage
...
object AllBridgeProvider : IMultiSwapProvider {
    ...
    override suspend fun start() {
        tokensMap = SwapProviderCacheHelper.getOrFetch(
            providerId = id,
            deserialize = { APIClient.gson.fromJson(it, ABToken::class.java) },
            serialize = { APIClient.gson.toJson(it) },
    ...
    override suspend fun fetchFinalQuote(
        ...
        swapQuote: SwapQuote,
        recipient: io.horizontalsystems.core.entities.Address?,
        slippage: BigDecimal,
    ): SwapFinalQuote {
        val amountOut = estimateAmountOut(tokenIn, tokenOut, amountIn)
