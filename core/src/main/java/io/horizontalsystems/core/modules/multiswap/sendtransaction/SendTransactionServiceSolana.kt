...
import io.horizontalsystems.core.modules.send.solana.SendSolanaAddressService
    ...
    override suspend fun setSendTransactionData(data: SendTransactionData) {
        ...
        when (data) {
            ...
            is SendTransactionData.Solana.Simple -> {
                ...
                addressService.setAddress(io.horizontalsystems.core.entities.Address(data.address))
                simpleDataSet = true
                emitState()
            }
        }
