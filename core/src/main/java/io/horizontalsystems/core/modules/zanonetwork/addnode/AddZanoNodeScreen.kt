package io.horizontalsystems.core.modules.zanonetwork.addnode
...
fun AddZanoNodeScreen(navigation: HSNavigation) {
    ...
    HSScaffold(
        title = stringResource(R.string.AddZanoNode_AddNode),
        menuItems = listOf(
            MenuItem(
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            Column(
                ...
                HeaderText(stringResource(R.string.AddZanoNode_NodeUrl))
                FormsInput(
