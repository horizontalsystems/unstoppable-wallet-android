...
import io.horizontalsystems.walletkit.modules.evmfee.Eip1559FeeSettings
import io.horizontalsystems.walletkit.modules.evmfee.EvmCommonGasDataService
import io.horizontalsystems.walletkit.modules.evmfee.EvmFeeModule
import io.horizontalsystems.walletkit.modules.evmfee.EvmFeeService
import io.horizontalsystems.walletkit.modules.evmfee.IEvmGasPriceService
import io.horizontalsystems.walletkit.modules.evmfee.LegacyFeeSettings
...
import io.horizontalsystems.walletkit.modules.evmfee.eip1559.Eip1559GasPriceService
import io.horizontalsystems.walletkit.modules.evmfee.legacy.LegacyFeeSettingsViewModel
import io.horizontalsystems.walletkit.modules.evmfee.legacy.LegacyGasPriceService
...
import io.horizontalsystems.walletkit.modules.send.evm.settings.SendEvmNonceService
import io.horizontalsystems.walletkit.modules.send.evm.settings.SendEvmNonceViewModel
import io.horizontalsystems.walletkit.modules.send.evm.settings.SendEvmSettingsModule
import io.horizontalsystems.walletkit.modules.send.evm.settings.SendEvmSettingsService
import io.horizontalsystems.walletkit.modules.send.evm.settings.SendEvmSettingsViewModel
...
class SendTransactionServiceEvm(
    ...
    private val _sendTransactionSettingsFlow = MutableStateFlow(
        SendTransactionSettingsEvm(null, evmKitWrapper.evmKit.receiveAddress)
    )
    ...
    override suspend fun setSendTransactionData(data: SendTransactionData) {
        ...
        feeService.setTransactionData(data.transactionData.toKitTransactionData())
    }
...
fun SendEvmNonceSettingsScreen(
    ...
    HSScaffold(
        ...
        Column(
            ...
            VSpacer(8.dp)
            val textColor = when {
                nonceUiState.errors.isNotEmpty() -> ComposeAppTheme.colors.lucian
                nonceUiState.warnings.isNotEmpty() -> ComposeAppTheme.colors.jacob
...
fun TransactionData.toEvmTransactionData() = EvmTransactionData(
    to = to.eip55,
    value = value,
    input = input,
)

internal fun EvmTransactionData.toKitTransactionData() = TransactionData(
    to = Address(to),
    value = value,
    input = input,
)
