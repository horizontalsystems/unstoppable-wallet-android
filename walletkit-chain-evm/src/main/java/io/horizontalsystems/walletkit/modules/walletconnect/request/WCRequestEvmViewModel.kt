...
import io.horizontalsystems.walletkit.modules.walletconnect.WCUtils
...
class WCRequestEvmViewModel(
    ...
    val blockchainType = WCUtils.getBlockchainType(sessionRequestEvent?.chainId)
    private val chainData = sessionRequestEvent?.let {
        WCUtils.getChainData(it.chainId)
    }
