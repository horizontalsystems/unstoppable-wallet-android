...
import com.quantum.wallet.subscriptions.core.HSPurchaseFailure
import com.quantum.wallet.subscriptions.core.IPaidAction
import com.quantum.wallet.subscriptions.core.PricingPhase
...
class SubscriptionServiceGooglePlay(
    ...
    override fun launchManageSubscriptionScreen(context: Context) {
        ...
        val packageName = "com.quantum.wallet.bankwallet"
